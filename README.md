...
Este repositório acadêmico destina-se ao armazenamento, versionamento e documentação das atividades, exercícios e projetos desenvolvidos ao longo da disciplina de **Inteligência Artificial**.

---

##  Descrição do Repositório

O repositório reúne os *notebooks* desenvolvidos na plataforma **Google Colab**, contemplando a implementação de algoritmos, análises de dados e rotinas práticas na linguagem Python, conforme as diretrizes pedagógicas da disciplina.
